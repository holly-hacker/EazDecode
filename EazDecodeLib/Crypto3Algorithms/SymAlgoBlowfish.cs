...
namespace EazDecodeLib.Crypto3Algorithms
{
    ...
    internal sealed class SymAlgoBlowfish : SymmetricAlgorithm
    {
        ...
        private ICryptoTransform GetCryptoTransform(byte[] key, byte[] iv, bool encrypt) => new CryptTrans(GetKey(key), encrypt);
        ...
        {
            private readonly BlowfishKey _blowfishKey;
            ...
            {
                //loop through all bytes and encrypt/decrypt them
